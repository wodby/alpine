...
PasswordAuthentication {{ getenv "SSHD_PASSWORD_AUTHENTICATION" }}
...
UsePAM {{ getenv "SSHD_USE_PAM" "yes" }}
...
UsePrivilegeSeparation  {{ getenv "SSHD_USE_PRIVILEGE_SEPARATION" "sandbox" }}

{{ if getenv "SSHD_DISABLE_STRICT_KEY_CHECKING" }}
Host *
